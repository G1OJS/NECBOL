...
helix = antenna_components.helix(length_mm = 67, diameter_mm = 78, pitch_mm = 25, wires_per_turn = 16, sense = 'RH', wire_diameter_mm = 1, taper_factor = 54/78)
helix.rotate_around_Z(45)
helix.translate(dx_mm = 0, dy_mm = 0, dz_mm = 4)

ground_plane = antenna_components.thin_sheet(model,  1, length_mm = 210, height_mm = 140, conducting_wire_diameter_mm = 3, grid_pitch_mm = 10 )
ground_plane.rotate_around_Y(90)
ground_plane.translate(dx_mm = 210/2 -90, dy_mm = 140/2 -80, dz_mm = 0)

top_sheet = antenna_components.thin_sheet(model,  4.2, length_mm = 80, height_mm = 80, dielectric_thickness_mm = 7, grid_pitch_mm = 5 )
top_sheet.rotate_around_Y(90)
top_sheet.translate(dx_mm = 0 , dy_mm = 0, dz_mm = 94)

feedwire = antenna_components.connector(helix, 0,0, ground_plane, 15, 8/14)
